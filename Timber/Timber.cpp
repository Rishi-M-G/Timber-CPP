...
int main()
{
	...
	*/
	...
	// Load the background texture using the path from the JSON config file
	...
	*/
	...
	// Load the Tree texture using the path from the JSON config file
	if (!textureTree.loadFromFile(config["graphics"]["tree"].get<std::string>())) {
